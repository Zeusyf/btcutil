...
func NewMinerBlockFromBytes(serializedBlock []byte) (*wire.MinerBlock, error) {
	br := bytes.NewReader(serializedBlock)
	b, err := NewMinerBlockFromReader(br)
	if err != nil {
		return nil, err
	}
//	b.serializedBlock = serializedBlock
